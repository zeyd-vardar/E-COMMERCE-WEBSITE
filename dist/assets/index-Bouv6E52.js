...
</button>`,W=(e,t,r)=>new Intl.NumberFormat(r==="tr"?"tr-TR":"en-US",{style:"currency",currency:t,maximumFractionDigits:t==="TRY"?0:2}).format(e*Ue.exchangeRates[t]),qe=e=>e.originalPrice?Math.round((e.originalPrice-e.price)/e.originalPrice*100):0,ct=(e,t,r)=>{const a=r??it(t).map(n=>n.slug),[s,i]=a,c=s==="sale"?e:e.filter(n=>!n.saleOnly);return s==="all"?c.filter(n=>i==="women"||i==="men"||i==="kids"?n.categoryId===i:i==="new-arrivals"?n.isNew:i==="best-sellers"?n.isBestSeller:!0):s==="sale"?e.filter(n=>{var u;return!!n.originalPrice&&(i==="women-sale"?n.categoryId==="women":i==="men-sale"?n.categoryId==="men":i==="kids-sale"?n.categoryId==="kids":i==="shoes-sale"?(u=n.categoryPath)==null?void 0:u.includes("shoes"):i==="accessories-sale"?n.categoryId==="accessories":i==="outlet-deals"?n.isOutlet:!0)}):s==="outlet"?c.filter(n=>{var u;return n.isOutlet&&(i==="women-outlet"?n.categoryId==="women":i==="men-outlet"?n.categoryId==="men":i==="kids-outlet"?n.categoryId==="kids":i==="shoes-outlet"?(u=n.categoryPath)==null?void 0:u.includes("shoes"):i==="accessories-outlet"?n.categoryId==="accessories":i==="last-chance"?!!n.originalPrice:!0)}):c.filter(n=>n.categoryPath?a.every((u,d)=>{var y;return((y=n.categoryPath)==null?void 0:y[d])===u}):a.length===1?n.categoryId===s:a.length===2?n.categoryId===s&&n.subcategoryId===i:!1)},Qt=(e,t)=>e.filter(r=>[...t].every(([a,s])=>!s.size||[...s].some(i=>{var c,n;return a==="category"?r.categoryId===i||r.subcategoryId===i||!!((c=r.categoryPath)!=null&&c.includes(i)):a==="clothingCategory"?!!((n=r.categoryPath)!=null&&n.includes("clothing")&&r.categoryPath.includes(i)):a==="brand"?r.brand===i:a==="color"?r.colors.includes(i):a==="size"?r.sizes.includes(i):a==="availability"?i==="in-stock"?r.stock>0:r.stock===0:a==="discount"?!!r.originalPrice:a==="minPrice"?r.price>=Number(i):a==="maxPrice"?r.price<=Number(i):!0}))),er=(e,t,r)=>[...e].sort((a,s)=>t==="price-asc"?a.price-s.price:t==="price-desc"?s.price-a.price:t==="newest"?s.createdAt-a.createdAt:t==="discount"?qe(s)-qe(a):t==="name-asc"?a.name[r].localeCompare(s.name[r],r):t==="name-desc"?s.name[r].localeCompare(a.name[r],r):Number(s.isBestSeller)-Number(a.isBestSeller)),tr=(e,t)=>t.filter(r=>r.id!==e.id).map(r=>({p:r,score:(r.subcategoryId===e.subcategoryId?4:0)+(r.categoryId===e.categoryId?2:0)+(r.brand===e.brand?1:0)+(Math.abs(r.price-e.price)<1e3?1:0)})).sort((r,a)=>a.score-r.score).slice(0,8).map(r=>r.p);class lt{constructor(t){He(this,"values");this.key=t,this.values=new Set(P.getJson(t,[]))}has(t){return this.values.has(t)}all(){return[...this.values]}toggle(t){return this.values.has(t)?this.values.delete(t):this.values.add(t),this.save(),this.values.has(t)}remove(t){this.values.delete(t),this.save()}clear(){this.values.clear(),this.save()}save(){P.setJson(this.key,this.all())}}const te=new lt("aurea-favorites"),H=new lt("aurea-comparison"),dt=(e,t,r,a)=>{const s=qe(e),i=e.images.length;return`<article class="catalog-card" data-product-id="${e.id}">
...
</article>`},ve=e=>[...new Set(e)].filter(Boolean).sort((t,r)=>t.localeCompare(r,"tr")),rr={women:{tr:"Kadın",en:"Women"},men:{tr:"Erkek",en:"Men"},kids:{tr:"Çocuk",en:"Kids"},accessories:{tr:"Aksesuar",en:"Accessories"}},ut=new Map,mt=e=>e.forEach(t=>{ut.set(t.slug,t.name),t.children&&mt(t.children)});mt(ee);const ae=(e,t,r,a,s)=>r.length?`<fieldset>
<legend>
${t}
</legend>
...
</fieldset>`:"",sr=(e,t,r,a)=>{var $,f;const s=ve(a.map(m=>m.categoryId)),i=ve(a.filter(m=>{var h;return(h=m.categoryPath)==null?void 0:h.includes("clothing")}).map(m=>{var h;return((h=m.categoryPath)==null?void 0:h.at(-1))??""})),c=ve(a.map(m=>m.brand)),n=ve(a.flatMap(m=>m.colors)),u=ve(a.flatMap(m=>m.sizes)),d=(($=r.get("minPrice"))==null?void 0:$.values().next().value)??"",y=((f=r.get("maxPrice"))==null?void 0:f.values().next().value)??"",T=[ae("category",t==="tr"?"Kategori":"Category",s,r,m=>{var h;return((h=rr[m])==null?void 0:h[t])??m}),ae("clothingCategory",t==="tr"?"Giyim Kategorisi":"Clothing Category",i,r,m=>{var h;return((h=ut.get(m))==null?void 0:h[t])??m}),ae("brand",t==="tr"?"Marka":"Brand",c,r),ae("color",t==="tr"?"Renk":"Color",n,r),ae("size",t==="tr"?"Beden":"Size",u,r),ae("availability",t==="tr"?"Stok Durumu":"Availability",["in-stock","out-of-stock"],r,m=>m==="in-stock"?t==="tr"?"Stokta var":"In stock":t==="tr"?"Stokta yok":"Out of stock"),ae("discount",t==="tr"?"İndirim":"Discount",["discounted"],r,()=>t==="tr"?"İndirimli ürünler":"On sale")].join("");return`<div class="filter-overlay">
</div>
...
${[...se].flatMap(([f,m])=>[...m].map(h=>`<button data-remove-filter="${f}:${h}">
${h} ×</button>`)).join("")}
</div>
${u.length?`<section class="catalog-grid" aria-label="${i.name[e]}">
${u.slice(0,d).map((f,m)=>dt(f,e,t,m)).join("")}
</section>
...
${sr(r,e,se,n)}${ar(H.all().length,e)}${pt(e)}`},kr=()=>{Z=ie,se=new Map},Sr=(e,t,r,a)=>{var m,h,g,A,O,b,v,q,R,K,Y;document.querySelector(".sort-select").value=vt();const s=()=>{$e==null||$e.disconnect(),t()};document.querySelectorAll(".catalog-card").forEach(k=>{var D,F,he,ye;const L=k.dataset.productId;(D=k.querySelector(".catalog-favorite"))==null||D.addEventListener("click",l=>{const p=te.toggle(L);l.currentTarget.classList.toggle("is-active",p),r(p?e==="tr"?"Favorilere eklendi.":"Added to favorites.":e==="tr"?"Favorilerden çıkarıldı.":"Removed from favorites.")}),(F=k.querySelector(".compare-input"))==null||F.addEventListener("change",()=>{H.toggle(L),s()}),(he=k.querySelector(".add-cart"))==null||he.addEventListener("click",()=>{N.add(L);const l=document.querySelector(".cart-count");l&&(l.textContent=String(N.count()),l.classList.add("is-visible")),r(e==="tr"?"Ürün sepete eklendi.":"Added to cart.")}),(ye=k.querySelector(".notify-btn"))==null||ye.addEventListener("click",()=>$())});const i=document.querySelector(".filter-drawer"),c=document.querySelector(".filter-overlay"),n=k=>{var L;i==null||i.classList.toggle("is-open",k),c==null||c.classList.toggle("is-open",k),i==null||i.setAttribute("aria-hidden",String(!k)),k&&((L=i==null?void 0:i.querySelector("button"))==null||L.focus())};(m=document.querySelector(".filter-trigger"))==null||m.addEventListener("click",()=>n(!0)),(h=document.querySelector(".filter-close"))==null||h.addEventListener("click",()=>n(!1)),c==null||c.addEventListener("click",()=>n(!1)),(g=document.querySelector(".filter-apply"))==null||g.addEventListener("click",()=>{const k=new Map;i==null||i.querySelectorAll("[data-filter-key]:checked").forEach(L=>{const D=L.dataset.filterKey;k.has(D)||k.set(D,new Set),k.get(D).add(L.value)}),i==null||i.querySelectorAll("[data-price-filter]").forEach(L=>{const D=L.value.trim();D&&k.set(L.dataset.priceFilter,new Set([D]))}),se=k,Z=ie,s()});const u=()=>{se.clear(),Z=ie,s()};(A=document.querySelector(".filter-clear"))==null||A.addEventListener("click",u),(O=document.querySelector(".empty-clear"))==null||O.addEventListener("click",u),document.querySelectorAll("[data-remove-filter]").forEach(k=>k.addEventListener("click",()=>{var F;const[L,D]=k.dataset.removeFilter.split(":");(F=se.get(L))==null||F.delete(D),Z=ie,s()})),(b=document.querySelector(".sort-select"))==null||b.addEventListener("change",k=>{const L=k.target.value,D=new URL(location.href);L==="recommended"?D.searchParams.delete("sort"):D.searchParams.set("sort",L),history.replaceState({},"",D),Z=ie,s()}),(v=document.querySelector(".comparison-clear"))==null||v.addEventListener("click",()=>{H.clear(),s()}),(q=document.querySelector("[data-compare-route]"))==null||q.addEventListener("click",k=>{k.preventDefault(),a("/compare")});const d=document.querySelector(".infinite-sentinel");d&&Z<Be(e).length&&($e=new IntersectionObserver(k=>{var L;(L=k[0])!=null&&L.isIntersecting&&(Z=Math.min(Z+ie,Be(e).length),s())},{rootMargin:"500px"}),$e.observe(d));const y=document.querySelector(".notify-dialog"),T=document.querySelector(".modal-overlay");function $(){y==null||y.showModal(),T==null||T.classList.add("is-open")}const f=()=>{y==null||y.close(),T==null||T.classList.remove("is-open")};(R=document.querySelector(".notify-close"))==null||R.addEventListener("click",f),T==null||T.addEventListener("click",f),(K=y==null?void 0:y.querySelector("form"))==null||K.addEventListener("submit",k=>{k.preventDefault(),k.currentTarget.reportValidity()&&(f(),r(e==="tr"?"Talebiniz alındı. Ürün tekrar stoklara geldiğinde bilgilendirileceksiniz.":"Request received. We’ll notify you when it is back."))}),(Y=document.querySelector(".compare-toolbar"))==null||Y.addEventListener("click",()=>H.all().length>=2?a("/compare"):r(e==="tr"?"Karşılaştırmak için en az 2 ürün seçin.":"Select at least 2 products."))},Er=(e,t)=>{const r=x.filter(s=>H.has(s.id)),a=[...new Set(r.flatMap(s=>Object.keys(s.attributes)))];return`${ge("",e)}
...
${e.sizes.map((s,i)=>`<button data-size="${s}" class="${M===s?"is-active":""}" ${i===1&&e.stock<5?"disabled":""}>
${s}
</button>`).join("")}
</div>
</div>`:""}
...
</main>`;wr.add(r.id);const a=Se.find(c=>c.id===r.categoryId),s=Se.find(c=>c.id===r.subcategoryId),i=tr(r,x).slice(0,4);return document.title=`${r.name[e]} | STORE`,`${ge(r.categoryId,e)}
...
</div>`},St=()=>{pe=0,oe="",M="",_=1},Dr=e=>e==="Siyah"?"brightness(.72) contrast(1.08)":e==="Kum"?"sepia(.2) saturate(.82) brightness(1.06)":e==="Haki"?"sepia(.25) hue-rotate(28deg) saturate(.78)":e==="Lacivert"?"brightness(.78) saturate(1.15) hue-rotate(178deg)":"brightness(1.06) saturate(.82)",ue=(e,t,r)=>{var a,s;return((s=(a=e.variantStock)==null?void 0:a[t])==null?void 0:s[r])??Math.max(0,Math.min(e.stock,(e.id.length+t.length+e.sizes.indexOf(r))%5===0?0:1+(e.stock+e.sizes.indexOf(r))%4))},Mr=(e,t,r,a)=>{var $,f,m,h,g,A,O;const s=ft($t());if(!s)return;const i=()=>oe||s.colors[0]||"",c=()=>{const b=document.querySelector(".cart-count");b&&(b.textContent=String(N.count()),b.classList.toggle("is-visible",N.count()>0))},n=()=>{var Y;const b=i(),v=Dr(b),q=`#variant-${encodeURIComponent(b)}`;(Y=document.querySelector(".variant-group strong"))==null||Y.replaceChildren(b),document.querySelectorAll(".detail-gallery img,.image-viewer img").forEach(k=>{k.src=`${s.images[0].split("#")[0]}${q}`,k.style.filter=v}),document.querySelectorAll("[data-color]").forEach(k=>{const L=k.dataset.color===b;k.classList.toggle("is-active",L),k.setAttribute("aria-pressed",String(L))}),document.querySelectorAll("[data-size]").forEach(k=>{const L=k.dataset.size??"",D=ue(s,b,L),F=M===L;k.disabled=D===0,k.classList.toggle("is-active",F),k.setAttribute("aria-pressed",String(F)),k.setAttribute("aria-label",`${e==="tr"?"Beden":"Size"} ${L}${D===0?` — ${e==="tr"?"stokta yok":"out of stock"}`:""}`)});const R=M?ue(s,b,M):s.stock,K=document.querySelector(".stock-note");K&&(K.textContent=R===0?e==="tr"?"Bu varyant stokta yok":"This variant is out of stock":R<=3?e==="tr"?`Bu varyantta son ${R} ürün`:`Only ${R} left in this variant`:e==="tr"?"Stokta":"In stock")};n(),document.querySelectorAll("[data-image-index]").forEach(b=>b.addEventListener("click",()=>{pe=Number(b.dataset.imageIndex),t()})),document.querySelectorAll("[data-color]").forEach(b=>b.addEventListener("click",()=>{oe=b.dataset.color??"",pe=0,M&&ue(s,oe,M)===0&&(M=""),n()})),document.querySelectorAll("[data-size]").forEach(b=>b.addEventListener("click",()=>{M=b.dataset.size??"",_=Math.min(_,ue(s,i(),M)),n()})),document.querySelectorAll(".quantity-minus").forEach(b=>b.addEventListener("click",()=>{_=Math.max(1,_-1),t()})),document.querySelectorAll(".quantity-plus").forEach(b=>b.addEventListener("click",()=>{const v=M?ue(s,i(),M):s.stock;_=Math.min(v,_+1),t()}));const u=()=>{if(s.sizes.length&&!M){r(e==="tr"?"Lütfen bir beden seçin.":"Please select a size.");return}if(M&&ue(s,i(),M)===0){r(e==="tr"?"Seçtiğiniz varyant stokta yok.":"The selected variant is out of stock.");return}for(let b=0;b<_;b++)N.add(s.id,{color:i()||void 0,size:M||void 0});c(),r(e==="tr"?`${i()} / ${M} sepete eklendi.`:`${i()} / ${M} added to cart.`)};document.querySelectorAll(".detail-add-cart").forEach(b=>b.addEventListener("click",u)),document.querySelectorAll(".detail-notify").forEach(b=>b.addEventListener("click",()=>{var v;return(v=document.querySelector(".notify-dialog"))==null?void 0:v.showModal()})),($=document.querySelector(".detail-favorite"))==null||$.addEventListener("click",()=>{te.toggle(s.id),t(),r(te.has(s.id)?e==="tr"?"Favorilere eklendi.":"Added to favorites.":e==="tr"?"Favorilerden çıkarıldı.":"Removed from favorites.")}),(f=document.querySelector(".detail-compare"))==null||f.addEventListener("click",()=>{H.toggle(s.id),t(),r(e==="tr"?"Karşılaştırma listeniz güncellendi.":"Comparison list updated.")}),document.querySelectorAll(".detail-accordions>div>button").forEach(b=>b.addEventListener("click",()=>{const v=b.getAttribute("aria-expanded")==="true";b.setAttribute("aria-expanded",String(!v)),b.querySelector("span").textContent=v?"+":"−",b.nextElementSibling.hidden=v}));const d=document.querySelector(".size-guide");(m=document.querySelector(".size-guide-open"))==null||m.addEventListener("click",()=>d==null?void 0:d.showModal()),(h=document.querySelector(".size-guide-close"))==null||h.addEventListener("click",()=>d==null?void 0:d.close()),(g=document.querySelector(".review-write"))==null||g.addEventListener("click",()=>r(e==="tr"?"Yorumunuz değerlendirilmek üzere alındı.":"Your review was received for moderation."));const y=document.querySelector(".viewer-overlay"),T=b=>y==null?void 0:y.classList.toggle("is-open",b);(A=document.querySelector(".image-viewer-open"))==null||A.addEventListener("click",()=>T(!0)),(O=document.querySelector(".viewer-close"))==null||O.addEventListener("click",()=>T(!1)),y==null||y.addEventListener("click",b=>{b.target===y&&T(!1)}),document.querySelectorAll(".detail-recommendations [data-product-route]").forEach(b=>b.addEventListener("click",v=>{v.preventDefault(),St(),a(`/product/${b.dataset.productRoute}`)}))},fe={address:{tr:`Merkez Mah. Örnek Cad. No: 10
İstanbul / Türkiye`,en:`Merkez District, Örnek Ave. No: 10
Istanbul / Türkiye`},phone:"+90 212 000 00 00",phoneHref:"+902120000000",email:"info@store.com"},zr={ios:"",android:""},j=(e,t,r,a)=>({id:e,label:{tr:t,en:r},href:a}),Pr=[{id:"corporate",title:{tr:"Kurumsal",en:"Corporate"},links:[j("about","Hakkımızda","About Us","/about"),j("mission","Misyonumuz","Our Mission","/mission"),j("stores","Mağazalarımız","Our Stores","/stores"),j("blog","Blog","Blog","/blog"),j("privacy","Gizlilik Bildirimi","Privacy Notice","/privacy")]},{id:"support",title:{tr:"Destek",en:"Support"},links:[j("contact","Bize Ulaşın","Contact Us","/contact"),j("returns","İade Şartları","Return Policy","/returns"),j("shipping","Sipariş ve Teslimat","Orders & Delivery","/shipping"),j("tracking","Sipariş Takip","Order Tracking","/tracking"),j("faq","Sıkça Sorulan Sorular","Frequently Asked Questions","/faq"),j("sitemap","Site Haritası","Sitemap","/sitemap")]}],Or=`<svg aria-hidden="true" viewBox="0 0 24 24">
...
</span>`},Fr=e=>V(I[e].addresses,e,`<div class="address-grid">
...
</form>`),jr=(e,t)=>V(I[e].orders,e,`<div class="account-list">
...
</div>`),Ur=(e,t)=>{const r=x.filter(a=>te.has(a.id));return V(I[e].favorites,e,r.length?`<div class="favorite-product-grid">
...
</div>`)},Gr=(e,t)=>{const r=N.all().map((a,s)=>({line:a,index:s,product:x.find(i=>i.id===a.productId)})).filter(a=>a.product);return r.length?V(I[e].cart,e,`<div class="cart-layout">
...
</div>`)},Hr=(e,t)=>{const r=Q.all().find(i=>i.isDefault)??Q.all()[0],a=ne.get(),s=N.all().map(i=>({line:i,product:x.find(c=>c.id===i.productId)})).filter(i=>i.product);return s.length?`<div class="checkout-head">
...
</div>`)},Wr=e=>{const t=ze.all().map(r=>({w:r,p:x.find(a=>a.id===r.productId)})).filter(r=>r.p);return V(I[e].stock,e,t.length?`<div class="account-product-list">
${t.map(({w:r,p:a})=>`<div>
<span>
<strong>
${a.brand}
...
</div>`)},Vr=e=>V(I[e].messages,e,`<div class="account-list">
...
</div>`),Jr=e=>{const t=ne.get();return V(I[e].profile,e,`<form class="profile-form">
<div>
<label>
${e==="tr"?"Ad":"First Name"}
...
</form>`)},Zr=e=>V(I[e].tracking,e,`<div class="tracking-box">
<form>
<label>
...
</div>`),_r=(e,t)=>{var i;const r=ne.get();let a="";const s=xr();if(s==="/account"){const c=I[e];a=`<header class="account-hero">
...
${a}
</main>`},Xr=(e,t,r,a)=>{var s,i,c,n,u;document.querySelectorAll("[data-account-route]").forEach(d=>d.addEventListener("click",y=>{y.preventDefault(),y.stopImmediatePropagation(),a(d.dataset.accountRoute)})),(s=document.querySelector(".signout-btn"))==null||s.addEventListener("click",()=>r(e==="tr"?"Oturumunuz açık bırakıldı.":"Your session remains active.")),(i=document.querySelector(".new-address-trigger"))==null||i.addEventListener("click",()=>{const d=document.querySelector(".address-form");d&&(d.hidden=!1)}),(c=document.querySelector(".address-form"))==null||c.addEventListener("submit",d=>{d.preventDefault();const y=new FormData(d.currentTarget);Q.add({id:`address-${Date.now()}`,title:String(y.get("title")),firstName:ne.get().firstName,lastName:ne.get().lastName,phone:String(y.get("phone")),addressLine:String(y.get("address")),city:String(y.get("city")),district:String(y.get("district")),country:"Türkiye",isDefault:!1}),r(e==="tr"?"Adresiniz kaydedildi.":"Address saved."),t()}),document.querySelectorAll("[data-delete-address]").forEach(d=>d.addEventListener("click",()=>{Q.remove(d.dataset.deleteAddress),t()})),document.querySelectorAll("[data-default-address]").forEach(d=>d.addEventListener("click",()=>{Q.makeDefault(d.dataset.defaultAddress),t()})),document.querySelectorAll("[data-remove-favorite]").forEach(d=>d.addEventListener("click",y=>{y.preventDefault(),y.stopImmediatePropagation(),te.remove(d.dataset.removeFavorite),t()})),document.querySelectorAll("[data-remove-stock]").forEach(d=>d.addEventListener("click",()=>{ze.remove(d.dataset.removeStock),t()})),(n=document.querySelector(".profile-form"))==null||n.addEventListener("submit",d=>{d.preventDefault();const y=new FormData(d.currentTarget);ne.save({id:"store-user",firstName:String(y.get("firstName")),lastName:String(y.get("lastName")),email:String(y.get("email")),phone:String(y.get("phone")),birthDate:String(y.get("birthDate"))}),r(e==="tr"?"Bilgileriniz kaydedildi.":"Your information was saved.")}),(u=document.querySelector(".tracking-box form"))==null||u.addEventListener("submit",d=>{d.preventDefault(),r(e==="tr"?"Sipariş durumu güncellendi.":"Order status updated.")}),document.querySelectorAll("[data-demo-action]").forEach(d=>d.addEventListener("click",()=>r(e==="tr"?"Sipariş detayları görüntüleniyor.":"Order details are displayed.")))},Qr=()=>{document.querySelectorAll(".catalog-gallery").forEach(e=>{const t=e.closest(".catalog-card"),r=[...(t==null?void 0:t.querySelectorAll(".catalog-gallery-dot"))??[]],a=[...(t==null?void 0:t.querySelectorAll(".catalog-gallery-arrow"))??[]];if(!r.length)return;let s=0;const i=c=>{s=Math.max(0,Math.min(r.length-1,c)),r.forEach((n,u)=>{const d=u===s;n.classList.toggle("is-active",d)}),a.forEach(n=>{const u=Number(n.dataset.galleryDirection);n.disabled=u<0&&s===0||u>0&&s===r.length-1}),e.scrollTo({left:e.clientWidth*s,behavior:"smooth"})};a.forEach(c=>c.addEventListener("click",()=>i(s+Number(c.dataset.galleryDirection))))})},At=document.querySelector("#app");if(!At)throw new Error("Application root was not found.");let E=P.get("aurea-language","tr",["tr","en"]),re=P.get("aurea-currency","TRY",["TRY","USD","EUR"]),Ke=0,Ne=0,tt=()=>{};const B=()=>{var u,d,y,T;document.documentElement.lang=E,document.body.classList.remove("menu-open","mega-menu-open"),N.prune(new Set(x.map($=>$.id)));const e=ce(),t=e.startsWith("/category/"),r=e==="/compare",a=e.startsWith("/product/"),s=e.startsWith("/account")||["/cart","/checkout","/favorites","/tracking"].includes(e);a||(document.title="STORE | Modern Essentials");const i=t?fr(E,re):r?Er(E,re):a?qr(E,re):s?_r(E,re):`<main>
${Vt(E)}${Jt(E)}
</main>`;document.body.classList.toggle("home-view",e==="/"),document.body.classList.toggle("catalog-view",t||r||a||s),document.body.classList.toggle("product-view",a),document.body.classList.toggle("account-view",s);const c=e.split("/").filter(Boolean),n=c[0]==="category"?c[1]??null:null;if(At.innerHTML=`${qt(E,re,N.count())}${Wt(E,re)}${i}${Nr(E)}${Zt(E)}${_t()}`,document.querySelectorAll("[data-mega-trigger]").forEach($=>{const f=n!==null&&$.dataset.categorySlug===n;$.classList.toggle("is-active",f),f?$.setAttribute("aria-current","page"):$.removeAttribute("aria-current")}),es(),Qr(),ts(),t&&Sr(E,B,X,G),a&&Mr(E,B,X,G),s){Xr(E,B,X,G),document.querySelectorAll("[data-cart-minus]").forEach(h=>h.addEventListener("click",()=>{const g=Number(h.dataset.cartMinus),A=N.all()[g];A&&(N.setQuantity(g,A.quantity-1),B())})),document.querySelectorAll("[data-cart-plus]").forEach(h=>h.addEventListener("click",()=>{const g=Number(h.dataset.cartPlus),A=N.all()[g];A&&(N.setQuantity(g,A.quantity+1),B())})),document.querySelectorAll("[data-cart-remove]").forEach(h=>h.addEventListener("click",()=>{N.remove(Number(h.dataset.cartRemove)),B()}));const $=document.querySelectorAll('input[name="payment"]'),f=document.querySelector(".card-fields"),m=()=>{var g;const h=((g=document.querySelector('input[name="payment"]:checked'))==null?void 0:g.value)==="card";f&&(f.hidden=!h,f.querySelectorAll("input").forEach(A=>A.required=h))};$.forEach(h=>h.addEventListener("change",m)),m(),(u=document.querySelector('input[name="cardNumber"]'))==null||u.addEventListener("input",h=>{const g=h.currentTarget;g.value=g.value.replace(/\D/g,"").slice(0,16).replace(/(.{4})/g,"$1 ").trim()}),(d=document.querySelector('input[name="expiry"]'))==null||d.addEventListener("input",h=>{const g=h.currentTarget,A=g.value.replace(/\D/g,"").slice(0,4);g.value=A.length>2?`${A.slice(0,2)}/${A.slice(2)}`:A}),(y=document.querySelector(".checkout-form"))==null||y.addEventListener("submit",h=>{h.preventDefault();const g=h.currentTarget;if(!g.reportValidity())return;g.hidden=!0;const A=document.querySelector(".checkout-success");A&&(A.hidden=!1),scrollTo({top:0,behavior:"smooth"})})}if(s){const $=document.querySelector(".address-form");document.querySelectorAll("[data-edit-address]").forEach(f=>f.addEventListener("click",()=>{const m=Q.all().find(h=>h.id===f.dataset.editAddress);!m||!$||($.hidden=!1,$.elements.namedItem("id").value=m.id,$.elements.namedItem("title").value=m.title,$.elements.namedItem("city").value=m.city,$.elements.namedItem("district").value=m.district,$.elements.namedItem("phone").value=m.phone,$.elements.namedItem("address").value=m.addressLine,$.querySelector("h2").textContent=E==="tr"?"Adresi Düzenle":"Edit Address",$.querySelector(":scope>button").textContent=E==="tr"?"DEĞİŞİKLİKLERİ KAYDET":"SAVE CHANGES",$.scrollIntoView({behavior:"smooth",block:"start"}))})),(T=document.querySelector(".new-address-trigger"))==null||T.addEventListener("click",()=>{$&&($.reset(),$.elements.namedItem("id").value="",$.querySelector("h2").textContent=E==="tr"?"Yeni Adres":"New Address",$.querySelector(":scope>button").textContent=E==="tr"?"ADRESİ KAYDET":"SAVE ADDRESS")}),$==null||$.addEventListener("submit",f=>{const m=f.currentTarget,h=m.elements.namedItem("id").value;if(!h)return;f.preventDefault(),f.stopImmediatePropagation();const g=new FormData(m),A=ne.get();Q.add({id:h,title:String(g.get("title")),firstName:A.firstName,lastName:A.lastName,phone:String(g.get("phone")),addressLine:String(g.get("address")),city:String(g.get("city")),district:String(g.get("district")),country:"Türkiye",isDefault:!1}),X(E==="tr"?"Adresiniz güncellendi.":"Address updated."),B()},{capture:!0})}},G=e=>{history.pushState({},"",vr(e)),e.startsWith("/category/")&&kr(),e.startsWith("/product/")&&St(),B(),scrollTo({top:0,behavior:"smooth"})},X=e=>{const t=document.querySelector("#toast");t&&(t.textContent=e??(E==="tr"?"Bu bölüm yakında eklenecek.":"This section is coming soon."),t.classList.add("is-visible"),window.setTimeout(()=>t.classList.remove("is-visible"),2600))},J=e=>{var i;const t=document.querySelector("#sidebar"),r=document.querySelector("#sidebar-overlay"),a=document.querySelector("#menu-trigger");if(!t||!r||!a)return;const s=matchMedia("(max-width: 767px)").matches;t.classList.toggle("is-open",e),r.classList.toggle("is-open",e),t.setAttribute("aria-hidden",String(!e)),a.setAttribute("aria-expanded",String(e)),document.body.classList.toggle("menu-open",e),e&&s&&((i=t.querySelector("button"))==null||i.focus())},ke=e=>{const t=document.querySelector("#mobile-search");t&&(t.classList.toggle("is-open",e),e&&window.setTimeout(()=>{var r;return(r=t.querySelector("input"))==null?void 0:r.focus()},120))},Re=e=>{var a;const t=document.querySelector(".support-panel"),r=document.querySelector(".sidebar-support-trigger");!t||!r||(t.classList.toggle("is-open",e),t.setAttribute("aria-hidden",String(!e)),r.setAttribute("aria-expanded",String(e)),e&&((a=t.querySelector("input"))==null||a.focus()))},Lt=(e,t=[])=>e.flatMap(r=>{const a=[...t,r.slug];return[{node:r,route:a.join("/")},...Lt(r.children??[],a)]}),rt=e=>{const t=e.closest(".search-shell"),r=t==null?void 0:t.querySelector(".search-results"),a=t==null?void 0:t.querySelector(".search-clear");if(!r)return;const s=e.value.trim(),i=s.toLocaleLowerCase(E==="tr"?"tr-TR":"en-US");if(a==null||a.classList.toggle("is-visible",!!s),!i){r.classList.remove("is-open"),r.innerHTML="";return}const c=x.filter(u=>`${u.name[E]} ${u.brand} ${u.categoryId}`.toLocaleLowerCase(E==="tr"?"tr-TR":"en-US").includes(i)).slice(0,5),n=Lt(ee).filter(({node:u})=>u.name[E].toLocaleLowerCase(E==="tr"?"tr-TR":"en-US").includes(i)).slice(0,5);r.innerHTML=c.length||n.length?`${c.length?`<p class="result-label">
...
</div>`,r.classList.add("is-open"),r.querySelectorAll("[data-search-product]").forEach(u=>u.addEventListener("click",d=>{d.button!==0||d.metaKey||d.ctrlKey||d.shiftKey||d.altKey||(d.preventDefault(),ke(!1),G(`/product/${u.dataset.searchProduct}`))})),r.querySelectorAll("[data-search-category]").forEach(u=>u.addEventListener("click",d=>{d.button!==0||d.metaKey||d.ctrlKey||d.shiftKey||d.altKey||(d.preventDefault(),ke(!1),G(`/category/${u.dataset.searchCategory}`))}))};function es(){var g,A,O,b,v,q,R,K,Y,k,L,D,F,he,ye;tt(),tt=rs();const e=document.querySelector(".site-header"),t=document.querySelector(".category-nav"),r=document.querySelector(".back-to-top"),a=()=>{var S;const l=Math.max(scrollY,0),p=l>Ne;if(p&&((S=document.querySelector(".mega-overlay.is-open"))==null||S.click()),e==null||e.classList.toggle("is-scrolled",l>24),r==null||r.classList.toggle("is-scroll-visible",l>20),t){const z=p&&l>140&&!document.body.classList.contains("menu-open");e==null||e.classList.toggle("scroll-hidden",z),t.classList.toggle("scroll-hidden",z)}else e==null||e.classList.remove("scroll-hidden");Ne=l};Ne=Math.max(scrollY,0),a(),window.onscroll=a;const s=document.querySelector("#menu-trigger");s==null||s.addEventListener("click",()=>J(s.getAttribute("aria-expanded")!=="true")),s==null||s.addEventListener("mouseenter",()=>{matchMedia("(hover: hover) and (min-width: 768px)").matches&&(clearTimeout(Ke),J(!0))});const i=document.querySelector("#sidebar");i==null||i.addEventListener("mouseenter",()=>clearTimeout(Ke)),[s,i].forEach(l=>l==null?void 0:l.addEventListener("mouseleave",()=>{matchMedia("(hover: hover) and (min-width: 768px)").matches&&(Ke=window.setTimeout(()=>J(!1),300))})),document.querySelectorAll(".sidebar-category-toggle").forEach(l=>l.addEventListener("click",()=>{var S;const p=l.getAttribute("aria-expanded")==="true";l.setAttribute("aria-expanded",String(!p)),(S=l.parentElement)==null||S.classList.toggle("is-open",!p)}));let c=0,n=null,u=null;const d=(l=!1)=>{var p;clearTimeout(c),n==null||n.classList.remove("is-open"),n==null||n.setAttribute("aria-hidden","true"),u==null||u.setAttribute("aria-expanded","false"),l&&(u==null||u.focus()),(p=document.querySelector(".mega-overlay"))==null||p.classList.remove("is-open"),document.body.classList.remove("mega-menu-open"),n=null,u=null},y=()=>{clearTimeout(c),c=window.setTimeout(()=>{!(n!=null&&n.contains(document.activeElement))&&!(u!=null&&u.contains(document.activeElement))&&d()},700)},T=()=>clearTimeout(c);document.querySelectorAll("[data-mega-trigger]").forEach(l=>{l.addEventListener("click",()=>{var z;const p=document.querySelector(`[data-mega-panel="${l.dataset.megaTrigger}"]`),S=l.getAttribute("aria-expanded")==="true";d(),!S&&p&&(n=p,u=l,l.setAttribute("aria-expanded","true"),p.classList.add("is-open"),p.setAttribute("aria-hidden","false"),(z=document.querySelector(".mega-overlay"))==null||z.classList.add("is-open"),document.body.classList.add("mega-menu-open"))}),l.addEventListener("pointerenter",T),l.addEventListener("pointerleave",y)}),document.querySelectorAll("[data-mega-panel]").forEach(l=>{l.addEventListener("pointerenter",T),l.addEventListener("pointerleave",y)});const $=document.querySelector(".category-nav");(g=document.querySelector(".mega-overlay"))==null||g.addEventListener("click",()=>d()),(A=document.querySelector(".sidebar-close"))==null||A.addEventListener("click",()=>J(!1)),(O=document.querySelector("#sidebar-overlay"))==null||O.addEventListener("click",()=>J(!1)),(b=document.querySelector(".mobile-search-trigger"))==null||b.addEventListener("click",()=>ke(!0)),(v=document.querySelector(".mobile-search-close"))==null||v.addEventListener("click",()=>ke(!1)),document.querySelectorAll(".search-shell input").forEach(l=>l.addEventListener("input",()=>rt(l))),document.querySelectorAll(".search-clear").forEach(l=>l.addEventListener("click",()=>{var S;const p=(S=l.parentElement)==null?void 0:S.querySelector("input");p&&(p.value="",rt(p),p.focus())}));const f=document.querySelector(".notify-dialog");if(document.querySelectorAll(".notify-btn").forEach(l=>l.addEventListener("click",()=>{var S;const p=(S=l.closest("[data-product-id]"))==null?void 0:S.dataset.productId;p&&f&&(f.dataset.productId=p)})),document.body.classList.contains("product-view")&&f){const l=x.find(p=>p.slug===ce().split("/").at(-1));l&&(f.dataset.productId=l.id)}(q=f==null?void 0:f.querySelector("form"))==null||q.addEventListener("submit",()=>{const l=f.dataset.productId;l&&ze.add(l)}),document.querySelectorAll("#currency,#sidebar-currency").forEach(l=>l.addEventListener("change",p=>{re=p.target.value,P.set("aurea-currency",re),B()}));const m=()=>{E=E==="tr"?"en":"tr",P.set("aurea-language",E),B()};(R=document.querySelector(".language-toggle"))==null||R.addEventListener("click",m),(K=document.querySelector(".sidebar-lang"))==null||K.addEventListener("click",m),document.querySelectorAll(".route-btn,[data-route]").forEach(l=>l.addEventListener("click",p=>{l.tagName==="A"&&p.preventDefault(),J(!1);const S=l.dataset.route,z={women:"women",men:"men",kids:"kids",accessories:"accessories",sale:"sale"},U={account:"/account",cart:"/cart",favorites:"/favorites",tracking:"/tracking"};S&&z[S]?G(`/category/${z[S]}`):S&&U[S]?G(U[S]):X()})),document.querySelectorAll("[data-category-route]").forEach(l=>l.addEventListener("click",p=>{if(p.button!==0||p.metaKey||p.ctrlKey||p.shiftKey||p.altKey)return;const S=l.dataset.categoryRoute;S&&(p.preventDefault(),clearTimeout(c),d(),J(!1),G(`/category/${S}`))})),document.querySelectorAll("[data-home-route]").forEach(l=>l.addEventListener("click",p=>{p.preventDefault(),G("/")})),document.querySelectorAll("[data-product-route]").forEach(l=>l.addEventListener("click",p=>{p.preventDefault(),p.stopImmediatePropagation(),G(`/product/${l.dataset.productRoute}`)}));const h=document.querySelector(".sidebar-support-trigger");if(h==null||h.addEventListener("click",()=>{J(!1),Re(!0)}),(Y=document.querySelector(".support-close"))==null||Y.addEventListener("click",()=>Re(!1)),(k=document.querySelector(".support-form"))==null||k.addEventListener("submit",l=>{l.preventDefault(),X(E==="tr"?"Mesajınız alındı.":"Your message was received."),Re(!1)}),document.querySelectorAll("[data-footer-route]").forEach(l=>l.addEventListener("click",p=>{p.preventDefault(),X(E==="tr"?"Bu sayfa sonraki geliştirme aşamasında eklenecek.":"This page will be added in the next development phase.")})),document.querySelectorAll("[data-app-store]").forEach(l=>l.addEventListener("click",()=>{const p=l.dataset.appStore==="ios"?"ios":"android",S=zr[p];S?location.assign(S):X(p==="ios"?E==="tr"?"Mobil uygulamamız yakında App Store’da.":"Our mobile app is coming soon to the App Store.":E==="tr"?"Mobil uygulamamız yakında Google Play’de.":"Our mobile app is coming soon to Google Play.")})),(L=document.querySelector(".back-to-top"))==null||L.addEventListener("click",()=>scrollTo({top:0,behavior:matchMedia("(prefers-reduced-motion: reduce)").matches?"auto":"smooth"})),document.querySelectorAll(".footer-section-toggle").forEach(l=>l.addEventListener("click",()=>{var S;const p=l.getAttribute("aria-expanded")==="true";l.setAttribute("aria-expanded",String(!p)),l.querySelector("i").textContent=p?"+":"−",(S=l.parentElement)==null||S.classList.toggle("is-open",!p)})),document.body.classList.contains("product-view")){const l=document.querySelector(".notify-dialog");(D=document.querySelector(".notify-close"))==null||D.addEventListener("click",()=>l==null?void 0:l.close()),(F=l==null?void 0:l.querySelector("form"))==null||F.addEventListener("submit",U=>{U.preventDefault(),U.currentTarget.reportValidity()&&(l.close(),X(E==="tr"?"Talebiniz alındı. Ürün tekrar stoklara geldiğinde bilgilendirileceksiniz.":"Request received. We’ll notify you when it is back."))});let p=0;const S=["0% 0%","100% 0%","0% 100%","100% 100%"],z=U=>{p=(p+U+S.length)%S.length;const be=document.querySelector(".image-viewer img");be&&(be.style.transformOrigin=S[p])};(he=document.querySelector(".viewer-prev"))==null||he.addEventListener("click",()=>z(-1)),(ye=document.querySelector(".viewer-next"))==null||ye.addEventListener("click",()=>z(1))}document.onclick=l=>{const p=l.target;document.querySelectorAll(".search-results.is-open").forEach(S=>{var z;(z=S.parentElement)!=null&&z.contains(p)||S.classList.remove("is-open")}),n&&!($!=null&&$.contains(p))&&d()},document.onkeydown=l=>{var p,S,z,U;l.key==="Escape"&&(d(!0),J(!1),ke(!1),Re(!1),document.querySelectorAll(".search-results").forEach(be=>be.classList.remove("is-open")),(p=document.querySelector(".filter-close"))==null||p.click(),(S=document.querySelector(".notify-close"))==null||S.click(),(z=document.querySelector(".viewer-close"))==null||z.click(),(U=document.querySelector(".size-guide-close"))==null||U.click())}}function ts(){if(matchMedia("(prefers-reduced-motion: reduce)").matches){document.querySelectorAll(".reveal").forEach(t=>t.classList.add("is-visible"));return}const e=new IntersectionObserver(t=>t.forEach(r=>{r.isIntersecting&&(r.target.classList.add("is-visible"),e.unobserve(r.target))}),{threshold:.12});document.querySelectorAll(".reveal").forEach(t=>e.observe(t))}function rs(){if(!document.body.classList.contains("home-view"))return()=>{};const e=[...document.querySelectorAll("main > .hero, main > .campaign-section, main > .gender-campaign")],t=document.querySelector(".site-footer"),r=t?[...e,t]:e;if(e.length<2)return()=>{};let a=!1,s=null,i=!1,c=!1,n=0,u=0,d=0,y=0;const T=v=>v.getBoundingClientRect().top+scrollY,$=()=>{let v=0,q=Number.POSITIVE_INFINITY;return r.forEach((R,K)=>{const Y=Math.abs(T(R)-scrollY);Y<q&&(v=K,q=Y)}),v},f=v=>{if(a||v<0||v>=r.length)return;const q=T(r[v]);if(Math.abs(q-scrollY)<2){i=!1;return}a=!0;const R=matchMedia("(prefers-reduced-motion: reduce)").matches;window.scrollTo({top:q,behavior:R?"auto":"smooth"}),window.clearTimeout(u),u=window.setTimeout(()=>{a=!1,i=!1},R?0:700)},m=v=>{if(i)return!1;const R=$()+v;return R<0||R>=r.length?!1:(i=!0,f(R),!0)},h=v=>{if(v.ctrlKey||document.body.classList.contains("menu-open")||document.querySelector(".mega-menu.is-open")||Math.abs(v.deltaY)<1)return;v.preventDefault();const q=v.deltaMode===WheelEvent.DOM_DELTA_LINE,R=Math.abs(v.deltaY);if(q){!a&&!i&&m(v.deltaY>0?1:-1);return}const K=c&&y<=d*.45&&R>Math.max(y*1.7,4);window.clearTimeout(n),n=window.setTimeout(()=>{c=!1,d=0,y=0},120),K&&(c=!1,d=0),y=R,d=Math.max(d,R),!(a||i||c)&&(c=!0,m(v.deltaY>0?1:-1))},g=v=>{var q;document.body.classList.contains("menu-open")||document.querySelector(".mega-menu.is-open")||(s=((q=v.touches[0])==null?void 0:q.clientY)??null)},A=v=>{s!==null&&!document.body.classList.contains("menu-open")&&v.preventDefault()},O=v=>{var K;if(s===null||a)return;const q=((K=v.changedTouches[0])==null?void 0:K.clientY)??s,R=s-q;s=null,!(Math.abs(R)<24)&&m(R>0?1:-1)},b=v=>{const q=v.target;if(q!=null&&q.matches('input, textarea, select, button, [contenteditable="true"]'))return;const R=v.key==="ArrowDown"||v.key==="PageDown"||v.key===" "?1:v.key==="ArrowUp"||v.key==="PageUp"?-1:0;!R||a||(v.preventDefault(),m(R))};return addEventListener("wheel",h,{passive:!1}),addEventListener("touchstart",g,{passive:!0}),addEventListener("touchmove",A,{passive:!1}),addEventListener("touchend",O,{passive:!0}),addEventListener("keydown",b),()=>{removeEventListener("wheel",h),removeEventListener("touchstart",g),removeEventListener("touchmove",A),removeEventListener("touchend",O),removeEventListener("keydown",b),clearTimeout(n),clearTimeout(u)}}B();addEventListener("popstate",()=>B());
