...
</article>`},be=e=>[...new Set(e)].filter(Boolean).sort((t,r)=>t.localeCompare(r,"tr")),ar={women:{tr:"Kadın",en:"Women"},men:{tr:"Erkek",en:"Men"},kids:{tr:"Çocuk",en:"Kids"},accessories:{tr:"Aksesuar",en:"Accessories"}},mt=new Map,pt=e=>e.forEach(t=>{mt.set(t.slug,t.name),t.children&&pt(t.children)});pt(ee);const oe=(e,t,r,a,s)=>r.length?`<fieldset>
<legend>
${t}
</legend>
...
</fieldset>`:"",ir=(e,t,r,a)=>{var b,f;const s=be(a.map(h=>h.categoryId)),i=be(a.filter(h=>{var p;return(p=h.categoryPath)==null?void 0:p.includes("clothing")}).map(h=>{var p;return((p=h.categoryPath)==null?void 0:p.at(-1))??""})),c=be(a.map(h=>h.brand)),n=be(a.flatMap(h=>h.colors)),u=be(a.flatMap(h=>h.sizes)),d=((b=r.get("minPrice"))==null?void 0:b.values().next().value)??"",y=((f=r.get("maxPrice"))==null?void 0:f.values().next().value)??"",L=[oe("category",t==="tr"?"Kategori":"Category",s,r,h=>{var p;return((p=ar[h])==null?void 0:p[t])??h}),oe("clothingCategory",t==="tr"?"Giyim Kategorisi":"Clothing Category",i,r,h=>{var p;return((p=mt.get(h))==null?void 0:p[t])??h}),oe("brand",t==="tr"?"Marka":"Brand",c,r),oe("color",t==="tr"?"Renk":"Color",n,r),oe("size",t==="tr"?"Beden":"Size",u,r),oe("availability",t==="tr"?"Stok Durumu":"Availability",["in-stock","out-of-stock"],r,h=>h==="in-stock"?t==="tr"?"Stokta var":"In stock":t==="tr"?"Stokta yok":"Out of stock"),oe("discount",t==="tr"?"İndirim":"Discount",["discounted"],r,()=>t==="tr"?"İndirimli ürünler":"On sale")].join("");return`<div class="filter-overlay">
</div>
...
</div>`,ht=e=>`<div class="modal-overlay">
</div>
...
</dialog>`,Je=["#E8E4DC","#DDE5E4","#E7DDD8","#E1E5DB","#E5DFE8","#E8E1D5"],nr=e=>e.replace(/[<>&'\"]/g,t=>({"<":"&lt;",">":"&gt;","&":"&amp;","'":"&apos;",'"':"&quot;"})[t]??t),he=(e,t)=>{const r=e.length>28?`${e.slice(0,27)}…`:e,a=r.length>22?30:r.length>15?36:44,s=`<svg xmlns="http://www.w3.org/2000/svg" width="900" height="1200" viewBox="0 0 900 1200">
...
${[...ae].flatMap(([f,h])=>[...h].map(p=>`<button data-remove-filter="${f}:${p}">
${p} ×</button>`)).join("")}
</div>
${u.length?`<section class="catalog-grid" aria-label="${i.name[e]}">
${u.slice(0,d).map((f,h)=>ut(f,e,t,h)).join("")}
</section>
...
${ir(r,e,ae,n)}${or(H.all().length,e)}${ht(e)}`},Sr=()=>{Z=ne,ae=new Map},Er=(e,t,r,a)=>{var h,p,g,T,B,v,M,S,R,D,P;document.querySelector(".sort-select").value=ft();const s=()=>{$e==null||$e.disconnect(),t()};document.querySelectorAll(".catalog-card").forEach($=>{var q,I,ie,re;const w=$.dataset.productId;(q=$.querySelector(".catalog-favorite"))==null||q.addEventListener("click",l=>{const m=te.toggle(w);l.currentTarget.classList.toggle("is-active",m),r(m?e==="tr"?"Favorilere eklendi.":"Added to favorites.":e==="tr"?"Favorilerden çıkarıldı.":"Removed from favorites.")}),(I=$.querySelector(".compare-input"))==null||I.addEventListener("change",()=>{H.toggle(w),s()}),(ie=$.querySelector(".add-cart"))==null||ie.addEventListener("click",()=>{N.add(w);const l=document.querySelector(".cart-count");l&&(l.textContent=String(N.count()),l.classList.add("is-visible")),r(e==="tr"?"Ürün sepete eklendi.":"Added to cart.")}),(re=$.querySelector(".notify-btn"))==null||re.addEventListener("click",()=>b())});const i=document.querySelector(".filter-drawer"),c=document.querySelector(".filter-overlay"),n=$=>{var w;i==null||i.classList.toggle("is-open",$),c==null||c.classList.toggle("is-open",$),i==null||i.setAttribute("aria-hidden",String(!$)),$&&((w=i==null?void 0:i.querySelector("button"))==null||w.focus())};(h=document.querySelector(".filter-trigger"))==null||h.addEventListener("click",()=>n(!0)),(p=document.querySelector(".filter-close"))==null||p.addEventListener("click",()=>n(!1)),c==null||c.addEventListener("click",()=>n(!1)),(g=document.querySelector(".filter-apply"))==null||g.addEventListener("click",()=>{const $=new Map;i==null||i.querySelectorAll("[data-filter-key]:checked").forEach(w=>{const q=w.dataset.filterKey;$.has(q)||$.set(q,new Set),$.get(q).add(w.value)}),i==null||i.querySelectorAll("[data-price-filter]").forEach(w=>{const q=w.value.trim();q&&$.set(w.dataset.priceFilter,new Set([q]))}),ae=$,Z=ne,s()});const u=()=>{ae.clear(),Z=ne,s()};(T=document.querySelector(".filter-clear"))==null||T.addEventListener("click",u),(B=document.querySelector(".empty-clear"))==null||B.addEventListener("click",u),document.querySelectorAll("[data-remove-filter]").forEach($=>$.addEventListener("click",()=>{var I;const[w,q]=$.dataset.removeFilter.split(":");(I=ae.get(w))==null||I.delete(q),Z=ne,s()})),(v=document.querySelector(".sort-select"))==null||v.addEventListener("change",$=>{const w=$.target.value,q=new URL(location.href);w==="recommended"?q.searchParams.delete("sort"):q.searchParams.set("sort",w),history.replaceState({},"",q),Z=ne,s()}),(M=document.querySelector(".comparison-clear"))==null||M.addEventListener("click",()=>{H.clear(),s()}),(S=document.querySelector("[data-compare-route]"))==null||S.addEventListener("click",$=>{$.preventDefault(),a("/compare")});const d=document.querySelector(".infinite-sentinel");d&&Z<Ie(e).length&&($e=new IntersectionObserver($=>{var w;(w=$[0])!=null&&w.isIntersecting&&(Z=Math.min(Z+ne,Ie(e).length),s())},{rootMargin:"500px"}),$e.observe(d));const y=document.querySelector(".notify-dialog"),L=document.querySelector(".modal-overlay");function b(){y==null||y.showModal(),L==null||L.classList.add("is-open")}const f=()=>{y==null||y.close(),L==null||L.classList.remove("is-open")};(R=document.querySelector(".notify-close"))==null||R.addEventListener("click",f),L==null||L.addEventListener("click",f),(D=y==null?void 0:y.querySelector("form"))==null||D.addEventListener("submit",$=>{$.preventDefault(),$.currentTarget.reportValidity()&&(f(),r(e==="tr"?"Talebiniz alındı. Ürün tekrar stoklara geldiğinde bilgilendirileceksiniz.":"Request received. We’ll notify you when it is back."))}),(P=document.querySelector(".compare-toolbar"))==null||P.addEventListener("click",()=>H.all().length>=2?a("/compare"):r(e==="tr"?"Karşılaştırmak için en az 2 ürün seçin.":"Select at least 2 products."))},gr=(e,t)=>{const r=F.filter(s=>H.has(s.id)),a=[...new Set(r.flatMap(s=>Object.keys(s.attributes)))];return`${we("",e)}
...
${e.sizes.map((s,i)=>`<button data-size="${s}" class="${O===s?"is-active":""}" ${i===1&&e.stock<5?"disabled":""}>
${s}
</button>`).join("")}
</div>
</div>`:""}
...
${ht(t)}`,Dr=(e,t)=>{const r=St(kt());if(!r)return`${we("",e)}
...
</div>`},gt=()=>{ye=0,ce="",O="",_=1},Mr=e=>e==="Siyah"?"brightness(.72) contrast(1.08)":e==="Kum"?"sepia(.2) saturate(.82) brightness(1.06)":e==="Haki"?"sepia(.25) hue-rotate(28deg) saturate(.78)":e==="Lacivert"?"brightness(.78) saturate(1.15) hue-rotate(178deg)":"brightness(1.06) saturate(.82)",pe=(e,t,r)=>{var a,s;return((s=(a=e.variantStock)==null?void 0:a[t])==null?void 0:s[r])??Math.max(0,Math.min(e.stock,(e.id.length+t.length+e.sizes.indexOf(r))%5===0?0:1+(e.stock+e.sizes.indexOf(r))%4))},zr=(e,t,r,a)=>{var b,f,h,p,g,T,B;const s=St(kt());if(!s)return;const i=()=>ce||s.colors[0]||"",c=()=>{const v=document.querySelector(".cart-count");v&&(v.textContent=String(N.count()),v.classList.toggle("is-visible",N.count()>0))},n=()=>{var P;const v=i(),M=Mr(v),S=`#variant-${encodeURIComponent(v)}`;(P=document.querySelector(".variant-group strong"))==null||P.replaceChildren(v),document.querySelectorAll(".detail-gallery img,.image-viewer img").forEach($=>{$.src=`${s.images[0].split("#")[0]}${S}`,$.style.filter=M}),document.querySelectorAll("[data-color]").forEach($=>{const w=$.dataset.color===v;$.classList.toggle("is-active",w),$.setAttribute("aria-pressed",String(w))}),document.querySelectorAll("[data-size]").forEach($=>{const w=$.dataset.size??"",q=pe(s,v,w),I=O===w;$.disabled=q===0,$.classList.toggle("is-active",I),$.setAttribute("aria-pressed",String(I)),$.setAttribute("aria-label",`${e==="tr"?"Beden":"Size"} ${w}${q===0?` — ${e==="tr"?"stokta yok":"out of stock"}`:""}`)});const R=O?pe(s,v,O):s.stock,D=document.querySelector(".stock-note");D&&(D.textContent=R===0?e==="tr"?"Bu varyant stokta yok":"This variant is out of stock":R<=3?e==="tr"?`Bu varyantta son ${R} ürün`:`Only ${R} left in this variant`:e==="tr"?"Stokta":"In stock")};n(),document.querySelectorAll("[data-image-index]").forEach(v=>v.addEventListener("click",()=>{ye=Number(v.dataset.imageIndex),t()})),document.querySelectorAll("[data-color]").forEach(v=>v.addEventListener("click",()=>{ce=v.dataset.color??"",ye=0,O&&pe(s,ce,O)===0&&(O=""),n()})),document.querySelectorAll("[data-size]").forEach(v=>v.addEventListener("click",()=>{O=v.dataset.size??"",_=Math.min(_,pe(s,i(),O)),n()})),document.querySelectorAll(".quantity-minus").forEach(v=>v.addEventListener("click",()=>{_=Math.max(1,_-1),t()})),document.querySelectorAll(".quantity-plus").forEach(v=>v.addEventListener("click",()=>{const M=O?pe(s,i(),O):s.stock;_=Math.min(M,_+1),t()}));const u=()=>{if(s.sizes.length&&!O){r(e==="tr"?"Lütfen bir beden seçin.":"Please select a size.");return}if(O&&pe(s,i(),O)===0){r(e==="tr"?"Seçtiğiniz varyant stokta yok.":"The selected variant is out of stock.");return}for(let v=0;v<_;v++)N.add(s.id,{color:i()||void 0,size:O||void 0});c(),r(e==="tr"?`${i()} / ${O} sepete eklendi.`:`${i()} / ${O} added to cart.`)};document.querySelectorAll(".detail-add-cart").forEach(v=>v.addEventListener("click",u)),document.querySelectorAll(".detail-notify").forEach(v=>v.addEventListener("click",()=>{var M;return(M=document.querySelector(".notify-dialog"))==null?void 0:M.showModal()})),(b=document.querySelector(".detail-favorite"))==null||b.addEventListener("click",()=>{te.toggle(s.id),t(),r(te.has(s.id)?e==="tr"?"Favorilere eklendi.":"Added to favorites.":e==="tr"?"Favorilerden çıkarıldı.":"Removed from favorites.")}),(f=document.querySelector(".detail-compare"))==null||f.addEventListener("click",()=>{H.toggle(s.id),t(),r(e==="tr"?"Karşılaştırma listeniz güncellendi.":"Comparison list updated.")}),document.querySelectorAll(".detail-accordions>div>button").forEach(v=>v.addEventListener("click",()=>{const M=v.getAttribute("aria-expanded")==="true";v.setAttribute("aria-expanded",String(!M)),v.querySelector("span").textContent=M?"+":"−",v.nextElementSibling.hidden=M}));const d=document.querySelector(".size-guide");(h=document.querySelector(".size-guide-open"))==null||h.addEventListener("click",()=>d==null?void 0:d.showModal()),(p=document.querySelector(".size-guide-close"))==null||p.addEventListener("click",()=>d==null?void 0:d.close()),(g=document.querySelector(".review-write"))==null||g.addEventListener("click",()=>r(e==="tr"?"Yorumunuz değerlendirilmek üzere alındı.":"Your review was received for moderation."));const y=document.querySelector(".viewer-overlay"),L=v=>y==null?void 0:y.classList.toggle("is-open",v);(T=document.querySelector(".image-viewer-open"))==null||T.addEventListener("click",()=>L(!0)),(B=document.querySelector(".viewer-close"))==null||B.addEventListener("click",()=>L(!1)),y==null||y.addEventListener("click",v=>{v.target===y&&L(!1)}),document.querySelectorAll(".detail-recommendations [data-product-route]").forEach(v=>v.addEventListener("click",M=>{M.preventDefault(),gt(),a(`/product/${v.dataset.productRoute}`)}))},fe={address:{tr:`Merkez Mah. Örnek Cad. No: 10
...
</svg>`,Br=`<svg aria-hidden="true" viewBox="0 0 24 24">
...
</div>`,r.classList.add("is-open"),r.querySelectorAll("[data-search-product]").forEach(u=>u.addEventListener("click",d=>{d.button!==0||d.metaKey||d.ctrlKey||d.shiftKey||d.altKey||(d.preventDefault(),Se(!1),G(`/product/${u.dataset.searchProduct}`))})),r.querySelectorAll("[data-search-category]").forEach(u=>u.addEventListener("click",d=>{d.button!==0||d.metaKey||d.ctrlKey||d.shiftKey||d.altKey||(d.preventDefault(),Se(!1),G(`/category/${u.dataset.searchCategory}`))}))};function ts(){var g,T,B,v,M,S,R,D,P,$,w,q,I,ie,re;rt(),rt=ss();const e=document.querySelector(".site-header"),t=document.querySelector(".category-nav"),r=document.querySelector(".back-to-top"),a=()=>{var k;const l=Math.max(scrollY,0),m=l>Ne;if(m&&((k=document.querySelector(".mega-overlay.is-open"))==null||k.click()),e==null||e.classList.toggle("is-scrolled",l>24),r==null||r.classList.toggle("is-scroll-visible",l>20),t){const z=m&&l>140&&!document.body.classList.contains("menu-open");e==null||e.classList.toggle("scroll-hidden",z),t.classList.toggle("scroll-hidden",z)}else e==null||e.classList.remove("scroll-hidden");Ne=l};Ne=Math.max(scrollY,0),a(),window.onscroll=a;const s=document.querySelector("#menu-trigger");s==null||s.addEventListener("click",()=>J(s.getAttribute("aria-expanded")!=="true")),s==null||s.addEventListener("mouseenter",()=>{matchMedia("(hover: hover) and (min-width: 768px)").matches&&(clearTimeout(Be),J(!0))});const i=document.querySelector("#sidebar");i==null||i.addEventListener("mouseenter",()=>clearTimeout(Be)),[s,i].forEach(l=>l==null?void 0:l.addEventListener("mouseleave",()=>{matchMedia("(hover: hover) and (min-width: 768px)").matches&&(Be=window.setTimeout(()=>J(!1),300))})),document.querySelectorAll(".sidebar-category-toggle").forEach(l=>l.addEventListener("click",()=>{var k;const m=l.getAttribute("aria-expanded")==="true";l.setAttribute("aria-expanded",String(!m)),(k=l.parentElement)==null||k.classList.toggle("is-open",!m)}));let c=0,n=null,u=null;const d=(l=!1)=>{var m;clearTimeout(c),n==null||n.classList.remove("is-open"),n==null||n.setAttribute("aria-hidden","true"),u==null||u.setAttribute("aria-expanded","false"),l&&(u==null||u.focus()),(m=document.querySelector(".mega-overlay"))==null||m.classList.remove("is-open"),document.body.classList.remove("mega-menu-open"),n=null,u=null},y=()=>{clearTimeout(c),c=window.setTimeout(()=>{!(n!=null&&n.contains(document.activeElement))&&!(u!=null&&u.contains(document.activeElement))&&d()},700)},L=()=>clearTimeout(c);document.querySelectorAll("[data-mega-trigger]").forEach(l=>{l.addEventListener("click",()=>{var z;const m=document.querySelector(`[data-mega-panel="${l.dataset.megaTrigger}"]`),k=l.getAttribute("aria-expanded")==="true";d(),!k&&m&&(n=m,u=l,l.setAttribute("aria-expanded","true"),m.classList.add("is-open"),m.setAttribute("aria-hidden","false"),(z=document.querySelector(".mega-overlay"))==null||z.classList.add("is-open"),document.body.classList.add("mega-menu-open"))}),l.addEventListener("pointerenter",L),l.addEventListener("pointerleave",y)}),document.querySelectorAll("[data-mega-panel]").forEach(l=>{l.addEventListener("pointerenter",L),l.addEventListener("pointerleave",y)});const b=document.querySelector(".category-nav");(g=document.querySelector(".mega-overlay"))==null||g.addEventListener("click",()=>d()),(T=document.querySelector(".sidebar-close"))==null||T.addEventListener("click",()=>J(!1)),(B=document.querySelector("#sidebar-overlay"))==null||B.addEventListener("click",()=>J(!1)),(v=document.querySelector(".mobile-search-trigger"))==null||v.addEventListener("click",()=>Se(!0)),(M=document.querySelector(".mobile-search-close"))==null||M.addEventListener("click",()=>Se(!1)),document.querySelectorAll(".search-shell input").forEach(l=>l.addEventListener("input",()=>st(l))),document.querySelectorAll(".search-clear").forEach(l=>l.addEventListener("click",()=>{var k;const m=(k=l.parentElement)==null?void 0:k.querySelector("input");m&&(m.value="",st(m),m.focus())}));const f=document.querySelector(".notify-dialog");if(document.querySelectorAll(".notify-btn").forEach(l=>l.addEventListener("click",()=>{var k;const m=(k=l.closest("[data-product-id]"))==null?void 0:k.dataset.productId;m&&f&&(f.dataset.productId=m)})),document.body.classList.contains("product-view")&&f){const l=F.find(m=>m.slug===de().split("/").at(-1));l&&(f.dataset.productId=l.id)}(S=f==null?void 0:f.querySelector("form"))==null||S.addEventListener("submit",()=>{const l=f.dataset.productId;l&&Pe.add(l)}),document.querySelectorAll("#currency,#sidebar-currency").forEach(l=>l.addEventListener("change",m=>{se=m.target.value,K.set("aurea-currency",se),x()}));const h=()=>{E=E==="tr"?"en":"tr",K.set("aurea-language",E),x()};(R=document.querySelector(".language-toggle"))==null||R.addEventListener("click",h),(D=document.querySelector(".sidebar-lang"))==null||D.addEventListener("click",h),document.querySelectorAll(".route-btn,[data-route]").forEach(l=>l.addEventListener("click",m=>{l.tagName==="A"&&m.preventDefault(),J(!1);const k=l.dataset.route,z={women:"women",men:"men",kids:"kids",accessories:"accessories",sale:"sale"},U={account:"/account",cart:"/cart",favorites:"/favorites",tracking:"/tracking"};k&&z[k]?G(`/category/${z[k]}`):k&&U[k]?G(U[k]):X()})),document.querySelectorAll("[data-category-route]").forEach(l=>l.addEventListener("click",m=>{if(m.button!==0||m.metaKey||m.ctrlKey||m.shiftKey||m.altKey)return;const k=l.dataset.categoryRoute;k&&(m.preventDefault(),clearTimeout(c),d(),J(!1),G(`/category/${k}`))})),document.querySelectorAll("[data-home-route]").forEach(l=>l.addEventListener("click",m=>{m.preventDefault(),G("/")})),document.querySelectorAll("[data-product-route]").forEach(l=>l.addEventListener("click",m=>{m.preventDefault(),m.stopImmediatePropagation(),G(`/product/${l.dataset.productRoute}`)}));const p=document.querySelector(".sidebar-support-trigger");if(p==null||p.addEventListener("click",()=>{J(!1),qe(!0)}),(P=document.querySelector(".support-close"))==null||P.addEventListener("click",()=>qe(!1)),($=document.querySelector(".support-form"))==null||$.addEventListener("submit",l=>{l.preventDefault(),X(E==="tr"?"Mesajınız alındı.":"Your message was received."),qe(!1)}),document.querySelectorAll("[data-footer-route]").forEach(l=>l.addEventListener("click",m=>{m.preventDefault(),X(E==="tr"?"Bu sayfa sonraki geliştirme aşamasında eklenecek.":"This page will be added in the next development phase.")})),document.querySelectorAll("[data-app-store]").forEach(l=>l.addEventListener("click",()=>{const m=l.dataset.appStore==="ios"?"ios":"android",k=Pr[m];k?location.assign(k):X(m==="ios"?E==="tr"?"Mobil uygulamamız yakında App Store’da.":"Our mobile app is coming soon to the App Store.":E==="tr"?"Mobil uygulamamız yakında Google Play’de.":"Our mobile app is coming soon to Google Play.")})),(w=document.querySelector(".back-to-top"))==null||w.addEventListener("click",()=>scrollTo({top:0,behavior:matchMedia("(prefers-reduced-motion: reduce)").matches?"auto":"smooth"})),document.querySelectorAll(".footer-section-toggle").forEach(l=>l.addEventListener("click",()=>{var k;const m=l.getAttribute("aria-expanded")==="true";l.setAttribute("aria-expanded",String(!m)),l.querySelector("i").textContent=m?"+":"−",(k=l.parentElement)==null||k.classList.toggle("is-open",!m)})),document.body.classList.contains("product-view")){const l=document.querySelector(".notify-dialog");(q=document.querySelector(".notify-close"))==null||q.addEventListener("click",()=>l==null?void 0:l.close()),(I=l==null?void 0:l.querySelector("form"))==null||I.addEventListener("submit",U=>{U.preventDefault(),U.currentTarget.reportValidity()&&(l.close(),X(E==="tr"?"Talebiniz alındı. Ürün tekrar stoklara geldiğinde bilgilendirileceksiniz.":"Request received. We’ll notify you when it is back."))});let m=0;const k=["0% 0%","100% 0%","0% 100%","100% 100%"],z=U=>{m=(m+U+k.length)%k.length;const ve=document.querySelector(".image-viewer img");ve&&(ve.style.transformOrigin=k[m])};(ie=document.querySelector(".viewer-prev"))==null||ie.addEventListener("click",()=>z(-1)),(re=document.querySelector(".viewer-next"))==null||re.addEventListener("click",()=>z(1))}document.onclick=l=>{const m=l.target;document.querySelectorAll(".search-results.is-open").forEach(k=>{var z;(z=k.parentElement)!=null&&z.contains(m)||k.classList.remove("is-open")}),n&&!(b!=null&&b.contains(m))&&d()},document.onkeydown=l=>{var m,k,z,U;l.key==="Escape"&&(d(!0),J(!1),Se(!1),qe(!1),document.querySelectorAll(".search-results").forEach(ve=>ve.classList.remove("is-open")),(m=document.querySelector(".filter-close"))==null||m.click(),(k=document.querySelector(".notify-close"))==null||k.click(),(z=document.querySelector(".viewer-close"))==null||z.click(),(U=document.querySelector(".size-guide-close"))==null||U.click())}}function rs(){if(matchMedia("(prefers-reduced-motion: reduce)").matches){document.querySelectorAll(".reveal").forEach(t=>t.classList.add("is-visible"));return}const e=new IntersectionObserver(t=>t.forEach(r=>{r.isIntersecting&&(r.target.classList.add("is-visible"),e.unobserve(r.target))}),{threshold:.12});document.querySelectorAll(".reveal").forEach(t=>e.observe(t))}function ss(){if(!document.body.classList.contains("home-view"))return()=>{};const e=[...document.querySelectorAll("main > .hero, main > .campaign-section, main > .gender-campaign")],t=document.querySelector(".site-footer"),r=t?[...e,t]:e;if(e.length<2)return()=>{};let a=!1,s=null,i=!1,c=!1,n=0,u=0,d=()=>{},y=0,L=0;const b=S=>S.getBoundingClientRect().top+scrollY,f=()=>{let S=0,R=Number.POSITIVE_INFINITY;return r.forEach((D,P)=>{const $=Math.abs(b(D)-scrollY);$<R&&(S=P,R=$)}),S},h=S=>{if(a||S<0||S>=r.length)return;const R=b(r[S]);if(Math.abs(R-scrollY)<2){i=!1;return}if(a=!0,matchMedia("(prefers-reduced-motion: reduce)").matches){window.scrollTo(0,R),a=!1,i=!1;return}const P=window.scrollY,$=R-P,w=600,q=document.documentElement,I=q.style.scrollBehavior,ie=q.style.scrollSnapType;q.style.scrollBehavior="auto",q.style.scrollSnapType="none",d=()=>{q.style.scrollBehavior=I,q.style.scrollSnapType=ie};let re;const l=m=>{re??(re=m);const k=Math.min((m-re)/w,1),z=k<.5?4*Math.pow(k,3):1-Math.pow(-2*k+2,3)/2;window.scrollTo(0,P+$*z),k<1?u=requestAnimationFrame(l):(u=0,d(),a=!1,i=!1)};u=requestAnimationFrame(l)},p=S=>{if(i)return!1;const D=f()+S;return D<0||D>=r.length?!1:(i=!0,h(D),!0)},g=S=>{if(S.ctrlKey||document.body.classList.contains("menu-open")||document.querySelector(".mega-menu.is-open")||Math.abs(S.deltaY)<1)return;S.preventDefault();const R=S.deltaMode===WheelEvent.DOM_DELTA_LINE,D=Math.abs(S.deltaY);if(R){!a&&!i&&p(S.deltaY>0?1:-1);return}const P=c&&L<=y*.45&&D>Math.max(L*1.7,4);window.clearTimeout(n),n=window.setTimeout(()=>{c=!1,y=0,L=0},120),P&&(c=!1,y=0),L=D,y=Math.max(y,D),!(a||i||c)&&(c=!0,p(S.deltaY>0?1:-1))},T=S=>{var R;document.body.classList.contains("menu-open")||document.querySelector(".mega-menu.is-open")||(s=((R=S.touches[0])==null?void 0:R.clientY)??null)},B=S=>{s!==null&&!document.body.classList.contains("menu-open")&&S.preventDefault()},v=S=>{var P;if(s===null||a)return;const R=((P=S.changedTouches[0])==null?void 0:P.clientY)??s,D=s-R;s=null,!(Math.abs(D)<24)&&p(D>0?1:-1)},M=S=>{const R=S.target;if(R!=null&&R.matches('input, textarea, select, button, [contenteditable="true"]'))return;const D=S.key==="ArrowDown"||S.key==="PageDown"||S.key===" "?1:S.key==="ArrowUp"||S.key==="PageUp"?-1:0;!D||a||(S.preventDefault(),p(D))};return addEventListener("wheel",g,{passive:!1}),addEventListener("touchstart",T,{passive:!0}),addEventListener("touchmove",B,{passive:!1}),addEventListener("touchend",v,{passive:!0}),addEventListener("keydown",M),()=>{removeEventListener("wheel",g),removeEventListener("touchstart",T),removeEventListener("touchmove",B),removeEventListener("touchend",v),removeEventListener("keydown",M),clearTimeout(n),cancelAnimationFrame(u),d()}}x();addEventListener("popstate",()=>x());
